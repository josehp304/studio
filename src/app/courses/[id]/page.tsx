                ...
                <Card>
                  <CardContent className="p-6 space-y-6">
                    ...
                    <p className="text-muted-foreground">
                      {course.title} provides a comprehensive overview of the subject, covering fundamental principles, industry-standard tools, and practical techniques. You'll learn to create intuitive and visually appealing outcomes, from initial concepts to final execution. By the end of this course, you'll have a strong portfolio and the skills to kickstart a career in this field.
                    </p>
                    <p className="text-muted-foreground">
                      We'll explore advanced topics and real-world applications. Through hands-on projects, you'll master essential tools and understand how to collaborate effectively in a professional environment.
                    </p>
                    <h3 className="text-xl font-bold font-headline text-primary">What you'll learn</h3>
                    <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {["Understand fundamental principles.", "Create real-world projects.", "Conduct research and analysis.", "Master industry-standard tools.", "Build a strong portfolio.", "Collaborate effectively."].map((item, i) => (
              ...
              <TabsContent value="instructor" className="mt-6">
                <Card>
                  <CardContent className="p-6 space-y-6">
                    ...
                    <p className="text-muted-foreground">
                      {course.instructor.name} is a seasoned professional with years of experience. They are passionate about teaching and mentoring the next generation.
                    </p>
                  </CardContent>
                </Card>
              </TabsContent>
            ...
            <Card className="shadow-lg sticky top-24">
              <CardContent className="p-0">
                ...
                <div className="p-6 space-y-4">
                  ...
                  <EnrollButton courseId={id} price={course.price} isEnrolled={isEnrolled} />
